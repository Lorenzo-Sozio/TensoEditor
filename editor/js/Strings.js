function Strings(config) {
	...
	const values = {
		fa: {
			...
			'menubar/file/saveData': 'ذخیره داده',

			'menubar/edit': 'تغییر',
			'menubar/edit/undo': 'بازگشت',
			'menubar/edit/redo': 'بازگشت به جلو',
			'menubar/edit/groupall': 'انتخاب همه',
			...
			'menubar/add/mesh/trapezoid': 'ذوزنقه',
		...
		en: {
			...
			'menubar/file/saveData': 'Save Data',

			'menubar/edit': 'Edit',
			'menubar/edit/undo': 'Undo',
			'menubar/edit/redo': 'Redo',
			'menubar/edit/groupall': 'Group All',
			...
			'menubar/add/mesh/trapezoid': 'Trapezoid',
			'menubar/add/mesh/torusknot': 'TorusKnot',
			'menubar/add/mesh/lathe': 'Lathe',
			'menubar/add/mesh/sprite': 'Sprite',
		...
		fr: {
			...
			'menubar/file/saveData': 'Enregistrer les données',

			'menubar/edit': 'Edition',
			'menubar/edit/undo': 'Annuler',
			'menubar/edit/redo': 'Refaire',
			'menubar/edit/groupall': 'Sélectionner tout',
			'menubar/edit/center': 'Center',
			...
			'menubar/add/mesh/torus': 'Torus',
			'menubar/add/mesh/tube': 'Tube',
			'menubar/add/mesh/trapezoid': 'Trapèze',
		...
		zh: {
			...
			'menubar/file/saveData': '保存数据',

			'menubar/edit': '编辑',
			'menubar/edit/undo': '撤销',
			'menubar/edit/redo': '重做',
			'menubar/edit/groupall': '全选',
		...
		ja: {
			...
			'menubar/file/saveData': 'データを保存',			

			'menubar/edit': '編集',
			'menubar/edit/undo': '元に戻す',
			'menubar/edit/redo': 'やり直す',
			'menubar/edit/groupall': 'すべて選択',
		...
		ko: {
			...
			'menubar/file/saveData': '데이터 저장',

			'menubar/edit': '편집',
			'menubar/edit/undo': '되돌리기',
			'menubar/edit/redo': '다시하기',
			'menubar/edit/groupall': '모두 선택',
			...
			'menubar/add/mesh/trapezoid': '사다리꼴',
		...
		it: {
			'prompt/file/open': 'I dati non salvati andranno persi. Sei sicuro?',
			'prompt/file/failedToOpenProject': 'Apertura progetto fallita!',
			'prompt/file/export/noMeshSelected': 'Nessuna mesh selezionata!',
			'prompt/file/export/noObjectSelected': 'Nessun oggetto selezionato!',
			'prompt/script/remove': 'Sei sicuro?',
			'prompt/history/clear': 'La cronologia Annulla/Ripristina verrà cancellata. Sei sicuro?',
			'prompt/history/preserve': 'La cronologia verrà preservata tra le sessioni.\nQuesto può influire sulle prestazioni quando si lavora con le texture.',
			'prompt/history/forbid': 'Annulla/Ripristina disabilitato durante la riproduzione della scena.',
			'prompt/rendering/realistic/unsupportedMaterial': 'Ombreggiatura REALISTIC: Solo MeshStandardMaterial e MeshPhysicalMaterial sono supportati',

			'command/AddObject': 'Aggiungi Oggetto',
			'command/AddScript': 'Aggiungi Script',
			'command/MoveObject': 'Sposta Oggetto',
			'command/MultiCmds': 'Modifiche Multiple',
			'command/RemoveObject': 'Rimuovi Oggetto',
			'command/RemoveScript': 'Rimuovi Script',
			'command/SetColor': 'Imposta Colore',
			'command/SetGeometry': 'Imposta Geometria',
			'command/SetGeometryValue': 'Imposta Valore Geometria',
			'command/SetMaterialColor': 'Imposta Colore Materiale',
			'command/SetMaterial': 'Imposta Materiale',
			'command/SetMaterialMap': 'Imposta Mappa Materiale',
			'command/SetMaterialRange': 'Imposta Gamma Materiale',
			'command/SetMaterialValue': 'Imposta Valore Materiale',
			'command/SetMaterialVector': 'Imposta Vettore Materiale',
			'command/SetPosition': 'Imposta Posizione',
			'command/SetRotation': 'Imposta Rotazione',
			'command/SetScale': 'Imposta Scala',
			'command/SetScene': 'Imposta Scena',
			'command/SetScriptValue': 'Imposta Valore Script',
			'command/SetShadowValue': 'Imposta Valore Ombra',
			'command/SetUuid': 'Imposta UUID',
			'command/SetValue': 'Imposta Valore',

			'menubar/file': 'File',
			'menubar/file/new': 'Nuovo',
			'menubar/file/new/empty': 'Vuoto',
			'menubar/file/new/Arkanoid': 'Arkanoid',
			'menubar/file/new/Camera': 'Camera',
			'menubar/file/new/Particles': 'Particelle',
			'menubar/file/new/Pong': 'Pong',
			'menubar/file/new/Shaders': 'Shader',
			'menubar/file/open': 'Apri',
			'menubar/file/save': 'Salva',
			'menubar/file/import': 'Importa',
			'menubar/file/export': 'Esporta',
			'menubar/file/saveData': 'Salva Dati',

			'menubar/edit': 'Modifica',
			'menubar/edit/undo': 'Annulla',
			'menubar/edit/redo': 'Ripristina',
			'menubar/edit/groupall': 'Raggruppa tutto',			
			'menubar/edit/center': 'Centra',
			'menubar/edit/clone': 'Clona',
			'menubar/edit/delete': 'Elimina',

			'menubar/add': 'Aggiungi',
			'menubar/add/group': 'Gruppo',
			'menubar/add/models': 'Modello',

			'menubar/add/mesh': 'Forma',
			'menubar/add/mesh/plane': 'Piano',
			'menubar/add/mesh/box': 'Cubo',
			'menubar/add/mesh/capsule': 'Capsula',
			'menubar/add/mesh/circle': 'Cerchio',
			'menubar/add/mesh/cylinder': 'Cilindro',
			'menubar/add/mesh/ring': 'Anello',
			'menubar/add/mesh/sphere': 'Sfera',
			'menubar/add/mesh/dodecahedron': 'Dodecaedro',
			'menubar/add/mesh/icosahedron': 'Icosaedro',
			'menubar/add/mesh/octahedron': 'Ottaedro',
			'menubar/add/mesh/tetrahedron': 'Tetraedro',
			'menubar/add/mesh/torus': 'Toro',
			'menubar/add/mesh/tube': 'Tubo',
			'menubar/add/mesh/trapezoid': 'Trapezio',
			'menubar/add/mesh/torusknot': 'Nodo Toroidale',
			'menubar/add/mesh/lathe': 'Tornio',
			'menubar/add/mesh/sprite': 'Sprite',

			'menubar/add/light': 'Luce',
			'menubar/add/light/ambient': 'Ambiente',
			'menubar/add/light/directional': 'Direzionale',
			'menubar/add/light/hemisphere': 'Emisferica',
			'menubar/add/light/point': 'Puntiforme',
			'menubar/add/light/spot': 'Spot',

			'menubar/add/camera': 'Telecamera',
			'menubar/add/camera/perspective': 'Prospettica',
			'menubar/add/camera/orthographic': 'Ortografica',

			'menubar/status/autosave': 'salvataggio automatico',

			'menubar/view': 'Visualizza',
			'menubar/view/fullscreen': 'Schermo Intero',
			'menubar/view/gridHelper': 'Griglia',
			'menubar/view/cameraHelpers': 'Aiuti Telecamera',
			'menubar/view/lightHelpers': 'Aiuti Luce',
			'menubar/view/skeletonHelpers': 'Aiuti Scheletro',

			'menubar/help': 'Aiuto',
			'menubar/help/source_code': 'Codice Sorgente',
			'menubar/help/icons': 'Pacchetto Icone',
			'menubar/help/about': 'Informazioni',
			'menubar/help/manual': 'Manuale',

			'sidebar/animations': 'Animazioni',
			'sidebar/animations/play': 'Riproduci',
			'sidebar/animations/stop': 'Ferma',
			'sidebar/animations/timescale': 'Scala Temporale',

			'sidebar/scene': 'Scena',
			'sidebar/scene/background': 'Sfondo',
			'sidebar/scene/environment': 'Ambiente',
			'sidebar/scene/fog': 'Nebbia',

			'sidebar/properties/object': 'Oggetto',
			'sidebar/properties/geometry': 'Geometria',
			'sidebar/properties/material': 'Materiale',
			'sidebar/properties/script': 'Script',

			'sidebar/object/type': 'Tipo',
			'sidebar/object/new': 'Nuovo',
			'sidebar/object/uuid': 'UUID',
			'sidebar/object/name': 'Nome',
			'sidebar/object/position': 'Posizione',
			'sidebar/object/rotation': 'Rotazione',
			'sidebar/object/scale': 'Scala',
			'sidebar/object/fov': 'Campo Visivo',
			'sidebar/object/left': 'Sinistra',
			'sidebar/object/right': 'Destra',
			'sidebar/object/top': 'Alto',
			'sidebar/object/bottom': 'Basso',
			'sidebar/object/near': 'Vicino',
			'sidebar/object/far': 'Lontano',
			'sidebar/object/intensity': 'Intensità',
			'sidebar/object/color': 'Colore',
			'sidebar/object/groundcolor': 'Colore Terreno',
			'sidebar/object/distance': 'Distanza',
			'sidebar/object/angle': 'Angolo',
			'sidebar/object/penumbra': 'Penombra',
			'sidebar/object/decay': 'Decadimento',
			'sidebar/object/shadow': 'Ombra',
			'sidebar/object/shadowIntensity': 'Intensità Ombra',
			'sidebar/object/shadowBias': 'Bias Ombra',
			'sidebar/object/shadowNormalBias': 'Bias Normale Ombra',
			'sidebar/object/shadowRadius': 'Raggio Ombra',
			'sidebar/object/cast': 'proietta',
			'sidebar/object/receive': 'riceve',
			'sidebar/object/visible': 'Visibile',
			'sidebar/object/frustumcull': 'Frustum Culling',
			...
			'sidebar/geometry/bounds': 'Limiti',
			'sidebar/geometry/userdata': 'Dati Utente',
			'sidebar/geometry/show_vertex_normals': 'Mostra Normali Vertici',
			'sidebar/geometry/compute_vertex_normals': 'Calcola Normali Vertici',
			'sidebar/geometry/compute_vertex_tangents': 'Calcola Tangenti',
			'sidebar/geometry/center': 'Centra',
			'sidebar/geometry/export': 'Esporta Oggetto (.JSON)',

			'sidebar/geometry/box_geometry/width': 'Larghezza',
			'sidebar/geometry/box_geometry/height': 'Altezza',
			'sidebar/geometry/box_geometry/depth': 'Profondità',
			'sidebar/geometry/box_geometry/widthseg': 'Segmenti Larghezza',
			'sidebar/geometry/box_geometry/heightseg': 'Segmenti Altezza',
			'sidebar/geometry/box_geometry/depthseg': 'Segmenti Profondità',

			'sidebar/geometry/buffer_geometry/attributes': 'Attributi',
			'sidebar/geometry/buffer_geometry/index': 'indice',
			'sidebar/geometry/buffer_geometry/morphAttributes': 'Attributi Morfologici',
			'sidebar/geometry/buffer_geometry/morphRelative': 'Morfologia Relativa',

			'sidebar/geometry/capsule_geometry/radius': 'Raggio',
			'sidebar/geometry/capsule_geometry/height': 'Lunghezza',
			'sidebar/geometry/capsule_geometry/capseg': 'Segmenti Estremità',
			'sidebar/geometry/capsule_geometry/radialseg': 'Segmenti Radiali',
			'sidebar/geometry/capsule_geometry/heightseg': 'Segmenti Altezza',

			'sidebar/geometry/circle_geometry/radius': 'Raggio',
			'sidebar/geometry/circle_geometry/segments': 'Segmenti',
			'sidebar/geometry/circle_geometry/thetastart': 'Inizio Theta (°)',
			'sidebar/geometry/circle_geometry/thetalength': 'Lunghezza Theta (°)',

			'sidebar/geometry/cylinder_geometry/radiustop': 'Raggio Superiore',
			'sidebar/geometry/cylinder_geometry/radiusbottom': 'Raggio Inferiore',
			'sidebar/geometry/cylinder_geometry/height': 'Altezza',
			'sidebar/geometry/cylinder_geometry/radialsegments': 'Segmenti Radiali',
			'sidebar/geometry/cylinder_geometry/heightsegments': 'Segmenti Altezza',
			'sidebar/geometry/cylinder_geometry/openended': 'Aperto',

			'sidebar/geometry/extrude_geometry/curveSegments': 'Segmenti Curva',
			'sidebar/geometry/extrude_geometry/steps': 'Passi',
			'sidebar/geometry/extrude_geometry/depth': 'Profondità',
			'sidebar/geometry/extrude_geometry/bevelEnabled': 'Smusso',
			'sidebar/geometry/extrude_geometry/bevelThickness': 'Spessore',
			'sidebar/geometry/extrude_geometry/bevelSize': 'Dimensione',
			'sidebar/geometry/extrude_geometry/bevelOffset': 'Offset',
			'sidebar/geometry/extrude_geometry/bevelSegments': 'Segmenti',
			'sidebar/geometry/extrude_geometry/shape': 'Converti in Forma',

			'sidebar/geometry/dodecahedron_geometry/radius': 'Raggio',
			'sidebar/geometry/dodecahedron_geometry/detail': 'Dettaglio',

			'sidebar/geometry/icosahedron_geometry/radius': 'Raggio',
			'sidebar/geometry/icosahedron_geometry/detail': 'Dettaglio',

			'sidebar/geometry/octahedron_geometry/radius': 'Raggio',
			'sidebar/geometry/octahedron_geometry/detail': 'Dettaglio',

			'sidebar/geometry/tetrahedron_geometry/radius': 'Raggio',
			'sidebar/geometry/tetrahedron_geometry/detail': 'Dettaglio',

			'sidebar/geometry/lathe_geometry/segments': 'Segmenti',
			'sidebar/geometry/lathe_geometry/phistart': 'Inizio Phi (°)',
			'sidebar/geometry/lathe_geometry/philength': 'Lunghezza Phi (°)',
			'sidebar/geometry/lathe_geometry/points': 'Punti',

			'sidebar/geometry/plane_geometry/width': 'Larghezza',
			'sidebar/geometry/plane_geometry/height': 'Altezza',
			'sidebar/geometry/plane_geometry/widthsegments': 'Segmenti Larghezza',
			'sidebar/geometry/plane_geometry/heightsegments': 'Segmenti Altezza',

			'sidebar/geometry/ring_geometry/innerRadius': 'Raggio Interno',
			'sidebar/geometry/ring_geometry/outerRadius': 'Raggio Esterno',
			'sidebar/geometry/ring_geometry/thetaSegments': 'Segmenti Theta',
			'sidebar/geometry/ring_geometry/phiSegments': 'Segmenti Phi',
			'sidebar/geometry/ring_geometry/thetastart': 'Inizio Theta',
			'sidebar/geometry/ring_geometry/thetalength': 'Lunghezza Theta',

			'sidebar/geometry/shape_geometry/curveSegments': 'Segmenti Curva',
			'sidebar/geometry/shape_geometry/extrude': 'Estrudi',

			'sidebar/geometry/sphere_geometry/radius': 'Raggio',
			'sidebar/geometry/sphere_geometry/widthsegments': 'Segmenti Larghezza',
			'sidebar/geometry/sphere_geometry/heightsegments': 'Segmenti Altezza',
			'sidebar/geometry/sphere_geometry/phistart': 'Inizio Phi (°)',
			'sidebar/geometry/sphere_geometry/philength': 'Lunghezza Phi (°)',
			'sidebar/geometry/sphere_geometry/thetastart': 'Inizio Theta',
			'sidebar/geometry/sphere_geometry/thetalength': 'Lunghezza Theta',

			'sidebar/geometry/torus_geometry/radius': 'Raggio',
			'sidebar/geometry/torus_geometry/tube': 'Tubo',
			'sidebar/geometry/torus_geometry/radialsegments': 'Segmenti Radiali',
			'sidebar/geometry/torus_geometry/tubularsegments': 'Segmenti Tubolari',
			'sidebar/geometry/torus_geometry/arc': 'Arco',

			'sidebar/geometry/torusKnot_geometry/radius': 'Raggio',
			'sidebar/geometry/torusKnot_geometry/tube': 'Tubo',
			'sidebar/geometry/torusKnot_geometry/tubularsegments': 'Segmenti Tubolari',
			'sidebar/geometry/torusKnot_geometry/radialsegments': 'Segmenti Radiali',
			'sidebar/geometry/torusKnot_geometry/p': 'P',
			'sidebar/geometry/torusKnot_geometry/q': 'Q',

			'sidebar/geometry/tube_geometry/path': 'Percorso',
			'sidebar/geometry/tube_geometry/radius': 'Raggio',
			'sidebar/geometry/tube_geometry/tube': 'Tubo',
			'sidebar/geometry/tube_geometry/tubularsegments': 'Segmenti Tubolari',
			'sidebar/geometry/tube_geometry/radialsegments': 'Segmenti Radiali',
			'sidebar/geometry/tube_geometry/closed': 'Chiuso',
			'sidebar/geometry/tube_geometry/curvetype': 'Tipo Curva',
			'sidebar/geometry/tube_geometry/tension': 'Tensione',

			'sidebar/material/new': 'Nuovo',
			'sidebar/material/copy': 'Copia',
			'sidebar/material/paste': 'Incolla',
			'sidebar/material/slot': 'Slot',
			'sidebar/material/type': 'Tipo',
			'sidebar/material/uuid': 'UUID',
			'sidebar/material/name': 'Nome',
			'sidebar/material/program': 'Programma',
			'sidebar/material/info': 'Info',
			'sidebar/material/vertex': 'Vert',
			'sidebar/material/fragment': 'Frag',
			'sidebar/material/color': 'Colore',
			'sidebar/material/depthPacking': 'Impacchettamento Profondità',
			'sidebar/material/roughness': 'Ruvidezza',
			'sidebar/material/metalness': 'Metallicità',
			'sidebar/material/reflectivity': 'Riflettività',
			'sidebar/material/emissive': 'Emissivo',
			'sidebar/material/specular': 'Speculare',
			'sidebar/material/shininess': 'Lucentezza',
			'sidebar/material/clearcoat': 'Vernice',
			'sidebar/material/clearcoatroughness': 'Ruvidezza Vernice',
			'sidebar/material/dispersion': 'Dispersione',
			'sidebar/material/ior': 'IOR',
			'sidebar/material/iridescence': 'Iridescenza',
			'sidebar/material/iridescenceIOR': 'IOR Film Sottile',
			'sidebar/material/iridescenceThicknessMax': 'Spessore Film Sottile',
			'sidebar/material/sheen': 'Lucidatura',
			'sidebar/material/sheenroughness': 'Ruvidezza Lucidatura',
			'sidebar/material/sheencolor': 'Colore Lucidatura',
			'sidebar/material/transmission': 'Trasmissione',
			'sidebar/material/attenuationDistance': 'Distanza Attenuazione',
			'sidebar/material/attenuationColor': 'Colore Attenuazione',
			'sidebar/material/thickness': 'Spessore',
			'sidebar/material/vertexcolors': 'Colori Vertici',
			'sidebar/material/matcap': 'Matcap',
			'sidebar/material/map': 'Mappa',
			'sidebar/material/alphamap': 'Mappa Alfa',
			'sidebar/material/bumpmap': 'Mappa Rilievo',
			'sidebar/material/normalmap': 'Mappa Normali',
			'sidebar/material/clearcoatmap': 'Mappa Vernice',
			'sidebar/material/clearcoatnormalmap': 'Mappa Normali Vernice',
			'sidebar/material/clearcoatroughnessmap': 'Mappa Ruvidezza Vernice',
			'sidebar/material/displacementmap': 'Mappa Dislocamento',
			'sidebar/material/roughnessmap': 'Mappa Ruvidezza',
			'sidebar/material/metalnessmap': 'Mappa Metallicità',
			'sidebar/material/specularmap': 'Mappa Speculare',
			'sidebar/material/iridescencemap': 'Mappa Iridescenza',
			'sidebar/material/iridescencethicknessmap': 'Mappa Spessore Film Sottile',
			'sidebar/material/sheencolormap': 'Mappa Colore Lucidatura',
			'sidebar/material/sheenroughnessmap': 'Mappa Ruvidezza Lucidatura',
			'sidebar/material/envmap': 'Mappa Ambiente',
			'sidebar/material/lightmap': 'Mappa Luce',
			'sidebar/material/aomap': 'Mappa AO',
			'sidebar/material/emissivemap': 'Mappa Emissiva',
			'sidebar/material/gradientmap': 'Mappa Gradiente',
			'sidebar/material/transmissionmap': 'Mappa Trasmissione',
			'sidebar/material/thicknessmap': 'Mappa Spessore',
			'sidebar/material/side': 'Lato',
			'sidebar/material/size': 'Dimensione',
			'sidebar/material/sizeAttenuation': 'Attenuazione Dimensione',
			'sidebar/material/flatShading': 'Ombreggiatura Piatta',
			'sidebar/material/blending': 'Miscelazione',
			'sidebar/material/opacity': 'Opacità',
			'sidebar/material/transparent': 'Trasparente',
			'sidebar/material/forcesinglepass': 'Forza Singolo Passaggio',
			'sidebar/material/alphatest': 'Test Alfa',
			'sidebar/material/depthtest': 'Test Profondità',
			'sidebar/material/depthwrite': 'Scrittura Profondità',
			'sidebar/material/wireframe': 'Wireframe',
			'sidebar/material/userdata': 'Dati Utente',
			'sidebar/material/export': 'Esporta JSON',

			'sidebar/script/new': 'Nuovo',
			'sidebar/script/edit': 'Modifica',
			'sidebar/script/remove': 'Rimuovi',

			'sidebar/project': 'Progetto',
			'sidebar/project/antialias': 'Antialiasing',
			'sidebar/project/shadows': 'Ombre',
			'sidebar/project/toneMapping': 'Mappatura Toni',
			'sidebar/project/materials': 'Materiali',
			'sidebar/project/Assign': 'Assegna',

			'sidebar/project/app': 'App',
			'sidebar/project/app/play': 'Riproduci',
			'sidebar/project/app/stop': 'Ferma',
			'sidebar/project/app/title': 'Titolo',
			'sidebar/project/app/editable': 'Modificabile',
			'sidebar/project/app/publish': 'Pubblica',

			'sidebar/project/image': 'Immagine',
			'sidebar/project/image/samples': 'Campioni',
			'sidebar/project/video': 'Video',

			'sidebar/project/shading': 'Ombreggiatura',
			'sidebar/project/resolution': 'Risoluzione',
			'sidebar/project/duration': 'Durata',
			'sidebar/project/render': 'Rendering',

			'sidebar/settings': 'Impostazioni',
			'sidebar/settings/language': 'Lingua',

			'sidebar/settings/shortcuts': 'Scorciatoie',
			'sidebar/settings/shortcuts/translate': 'Sposta',
			'sidebar/settings/shortcuts/rotate': 'Ruota',
			'sidebar/settings/shortcuts/scale': 'Scala',
			'sidebar/settings/shortcuts/undo': 'Annulla',
			'sidebar/settings/shortcuts/focus': 'Focus',

			'sidebar/history': 'Cronologia',
			'sidebar/history/clear': 'Cancella',
			'sidebar/history/persistent': 'Persistente',

			'toolbar/translate': 'Sposta',
			'toolbar/rotate': 'Ruota',
			'toolbar/scale': 'Scala',
			'toolbar/clone': 'Clona',
			...
			'viewport/info/object': 'Oggetto',
			'viewport/info/objects': 'Oggetti',
			'viewport/info/vertex': 'Vertice',
			'viewport/info/vertices': 'Vertici',
			'viewport/info/triangle': 'Triangolo',
			'viewport/info/triangles': 'Triangoli',
			'viewport/info/sample': 'Campione',
			'viewport/info/samples': 'Campioni',
			'viewport/info/rendertime': 'Tempo Rendering',

			'script/title/vertexShader': 'Vertex Shader',
			'script/title/fragmentShader': 'Fragment Shader',
			'script/title/programInfo': 'Proprietà Programma'
		}
	};
